    ...
    <>
      <section className="space-y-6 animate-in fade-in duration-500">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="glass-card p-4 rounded-xl flex flex-col hover:shadow-lg transition-all duration-300">
            <div className="flex items-center gap-4 mb-4">
              <div className="w-12 h-12 rounded-full border border-[#D4AF37]/20 shadow-inner" style={{ backgroundColor: '#800020' }}></div>
              <div>
                <p className="text-xs font-bold uppercase tracking-wider text-[#4A3F35]">Royal Maroon</p>
                <p className="text-[10px] text-gray-400 font-mono mt-0.5">HEX: #800020</p>
              </div>
            </div>
          ...
          <div className="glass-card p-4 rounded-xl flex flex-col hover:shadow-lg transition-all duration-300">
            <div className="flex items-center gap-4 mb-4">
              <div className="w-12 h-12 rounded-full border border-[#D4AF37]/20 shadow-inner" style={{ backgroundColor: '#004D40' }}></div>
              <div>
                <p className="text-xs font-bold uppercase tracking-wider text-[#4A3F35]">Emerald Green</p>
                <p className="text-[10px] text-gray-400 font-mono mt-0.5">HEX: #004D40</p>
              </div>
            </div>
            <div className="text-[10px] text-gray-500 mb-4 font-mono">
              <p>RGB: (0, 77, 64)</p>
          ...
          <div className="glass-card p-4 rounded-xl flex flex-col hover:shadow-lg transition-all duration-300">
            <div className="flex items-center gap-4 mb-4">
              <div className="w-12 h-12 rounded-full border border-[#D4AF37]/20 shadow-inner" style={{ backgroundColor: '#D4AF37' }}></div>
              <div>
                <p className="text-xs font-bold uppercase tracking-wider text-[#4A3F35]">Banarasi Gold</p>
                <p className="text-[10px] text-gray-400 font-mono mt-0.5">HEX: #D4AF37</p>
              </div>
            </div>
            <div className="text-[10px] text-gray-500 mb-4 font-mono">
              <p>RGB: (212, 175, 55)</p>
