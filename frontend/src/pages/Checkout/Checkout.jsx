...
const Checkout = () => {
  ...
  return (
    <div
      className="relative min-h-screen flex flex-col bg-[#F5F1E8]"
      ref={rootRef}
    >
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-8">
          ...
          <div className="flex items-center justify-center mb-16 space-x-4 md:space-x-12 animate-slide-up">
            ...
            <div className="flex items-center space-x-3">
              ...
              <span className="text-sm font-bold uppercase tracking-widest text-[#800020]">
                Checkout
              </span>
            </div>
            <div className="w-12 h-px bg-gray-300"></div>
            ...
            <div className="lg:col-span-8 space-y-12">
              ...
              <section className="bg-white rounded-2xl p-8 shadow-sm border border-[#D4AF37]/10 checkout-section">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="checkout-input-group">
                    <label className="block text-xs font-bold text-[#3D2817]/60 uppercase tracking-widest mb-2">
                      Full Name
                    </label>
                    <div className="checkout-input-inner">
                      <input
                        ...
                        className="w-full bg-[#F5F1E8]/50 border border-[#D4AF37]/30 rounded-lg px-4 py-3 focus:outline-none focus:border-[#800020] transition-colors"
                      />
                    </div>
                  </div>
                  <div className="checkout-input-group">
                  ...
                  <div className="checkout-input-group md:col-span-2">
                    ...
                    <div className="checkout-input-inner">
                      <input
                        ...
                        onChange={handleInputChange}
                        type="text"
                        placeholder="House No. 123, Heritage Lane"
                        className="w-full bg-[#F5F1E8]/50 border border-[#D4AF37]/30 rounded-lg px-4 py-3 focus:outline-none focus:border-[#800020] transition-colors"
                      />
                    </div>
                  </div>
              ...
              <section className="bg-white rounded-2xl p-8 shadow-sm border border-[#D4AF37]/10 checkout-section">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  {/* Card Option */}
                  <div
                    className={`payment-card group cursor-pointer ${activePayment === "card" ? "active" : ""}`}
                    onClick={() => setActivePayment("card")}
                  >
                    <div
                      className={`payment-card-inner p-6 border-2 rounded-xl flex flex-col items-center justify-center text-center transition-all ${activePayment === "card" ? "border-[#800020] bg-white" : "border-[#D4AF37]/10 bg-[#F5F1E8]/30"}`}
                    >
                      <iconify-icon
                        icon="lucide:credit-card"
                        className={`text-3xl mb-4 ${activePayment === "card" ? "text-[#800020]" : "text-[#D4AF37]"}`}
                      ></iconify-icon>
                  ...
                  {/* UPI Option */}
                  <div
                    className={`payment-card group cursor-pointer ${activePayment === "upi" ? "active" : ""}`}
                    onClick={() => setActivePayment("upi")}
                  >
                    <div
                      className={`payment-card-inner p-6 border-2 rounded-xl flex flex-col items-center justify-center text-center transition-all ${activePayment === "upi" ? "border-[#800020] bg-white" : "border-[#D4AF37]/10 bg-[#F5F1E8]/30"}`}
                    >
                      <iconify-icon
                        icon="simple-icons:phonepe"
                        className={`text-3xl mb-4 ${activePayment === "upi" ? "text-[#800020]" : "text-[#D4AF37]"}`}
                      ></iconify-icon>
                      <span className="font-bold text-[#3D2817]">
                        UPI Payment
                      </span>
                  ...
                  {/* Net Banking Option */}
                  <div
                    className={`payment-card group cursor-pointer ${activePayment === "net" ? "active" : ""}`}
                    onClick={() => setActivePayment("net")}
                  >
                    <div
                      className={`payment-card-inner p-6 border-2 rounded-xl flex flex-col items-center justify-center text-center transition-all ${activePayment === "net" ? "border-[#800020] bg-white" : "border-[#D4AF37]/10 bg-[#F5F1E8]/30"}`}
                    >
                      <iconify-icon
                        icon="lucide:landmark"
                        className={`text-3xl mb-4 ${activePayment === "net" ? "text-[#800020]" : "text-[#D4AF37]"}`}
                      ></iconify-icon>
                      <span className="font-bold text-[#3D2817]">
                        Net Banking
                      </span>
            ...
            <div className="lg:col-span-4">
              <div className="summary-card space-y-8 sticky top-28">
                <div className="bg-white rounded-2xl p-8 shadow-xl border border-[#D4AF37]/20">
                  <h3 className="text-xl font-bold text-[#3D2817] mb-8 uppercase tracking-widest border-b border-[#D4AF37]/10 pb-4 brand-font">
                    Order Summary
                  </h3>
                    ...
                    {cart.map((item) => (
                      ...
                      >
                        ...
                        <div className="flex-grow">
                          <h4 className="text-xs font-bold text-[#3D2817] line-clamp-1 uppercase tracking-wider">
                            {item.name}
                          </h4>
                  ...
                  <div className="mt-10 pt-6 border-t-2 border-[#D4AF37]/20">
                    <div className="flex justify-between items-center mb-8">
                      <span className="text-sm font-bold text-[#3D2817] uppercase tracking-[0.2em]">
                        Total Payable
                      </span>
                    ...
                    <p className="text-center text-[10px] text-gray-400 mt-4 uppercase tracking-[0.2em]">
                      ...
                      <a href="#" className="underline hover:text-[#800020]">
                        Terms
                      </a>
                    </p>
                  </div>
